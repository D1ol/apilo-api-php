<?php
/**
 * RestApiFinanceDocumentConfigsGet200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestApiFinanceDocumentConfigsGet200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestApiFinanceDocumentConfigsGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_rest_api_finance_document_configs__get_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'document_configs' => '\Apilo\Model\RestDocumentConfigDTO[]'
    ];
    ...
    protected static $setters = [
        ...
        'document_configs' => 'setDocumentConfigs'
    ];
    ...
    protected static $getters = [
        ...
        'document_configs' => 'getDocumentConfigs'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('document_configs', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling RestApiFinanceDocumentConfigsGet200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentOffset($current_offset)
    {
        ...
        if (($current_offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_offset when calling RestApiFinanceDocumentConfigsGet200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setPageResultCount($page_result_count)
    {
        ...
        if (($page_result_count > 512)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling RestApiFinanceDocumentConfigsGet200Response., must be smaller than or equal to 512.');
        }
        if (($page_result_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling RestApiFinanceDocumentConfigsGet200Response., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets document_configs
     *
     * @return \Apilo\Model\RestDocumentConfigDTO[]|null
     */
    public function getDocumentConfigs()
    {
        return $this->container['document_configs'];
    }

    /**
     * Sets document_configs
     *
     * @param \Apilo\Model\RestDocumentConfigDTO[]|null $document_configs document_configs
     *
     * @return self
     */
    public function setDocumentConfigs($document_configs)
    {
        if (is_null($document_configs)) {
            throw new \InvalidArgumentException('non-nullable document_configs cannot be null');
        }
        $this->container['document_configs'] = $document_configs;
