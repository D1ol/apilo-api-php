...
/**
 * RestOrderNoteDTO3 Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderNoteDTO3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderNoteDTO3';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Internal order ID in Apilo
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderNoteDTO3., must be smaller than or equal to 4294967295.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderNoteDTO3., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param string|null $type Type of the note
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Time when created note
     *
     * @return self
     */
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling RestOrderNoteDTO3., must be smaller than or equal to 1024.');
        }
