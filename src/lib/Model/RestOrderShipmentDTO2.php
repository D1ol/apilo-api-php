...
class RestOrderShipmentDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderShipmentDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setIdExternal($id_external)
    {
        ...
        if ((mb_strlen($id_external) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderShipmentDTO2., must be bigger than or equal to 1.');
        }
