 ...
 */
class PriceListModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceListModel';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Price list ID
     *
     * @return self
     */
