...
/**
 * RestStatusOrderDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestStatusOrderDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestStatusOrderDTO';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if (($status < 1)) {
            throw new \InvalidArgumentException('invalid value for $status when calling RestStatusOrderDTO., must be bigger than or equal to 1.');
        }
