<?php
/**
 * RestApiOrdersIdPaymentPost201Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestApiOrdersIdPaymentPost201Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestApiOrdersIdPaymentPost201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_rest_api_orders__id__payment__post_201_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['updates']) && ($this->container['updates'] < 0)) {
            $invalidProperties[] = "invalid value for 'updates', must be bigger than or equal to 0.";
        }
     ...
     * Sets updates
     *
     * @param int|null $updates Number of payment created
     *
     * @return self
     */
    public function setUpdates($updates)
    {
        ...
        if (($updates < 0)) {
            throw new \InvalidArgumentException('invalid value for $updates when calling RestApiOrdersIdPaymentPost201Response., must be bigger than or equal to 0.');
        }
