<?php
/**
 * RestApiOrdersIdStatusPut200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestApiOrdersIdStatusPut200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestApiOrdersIdStatusPut200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_rest_api_orders__id__status__put_200_response';
    ...
    */
     ...
     * Sets updates
     *
     * @param int|null $updates Number of updates
     *
     * @return self
     */
    public function setUpdates($updates)
    {
        ...
        if (($updates < 0)) {
            throw new \InvalidArgumentException('invalid value for $updates when calling RestApiOrdersIdStatusPut200Response., must be bigger than or equal to 0.');
        }
