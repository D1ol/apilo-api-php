...
/**
 * RestOrderNoteDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderNoteDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderNoteDTO';
    ...
    */
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling RestOrderNoteDTO., must be smaller than or equal to 1024.');
        }
