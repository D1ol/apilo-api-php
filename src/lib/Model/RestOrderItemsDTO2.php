...
/**
 * RestOrderItemsDTO2 Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderItemsDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderItemsDTO2';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['product_id']) && ($this->container['product_id'] > 4294967295)) {
            $invalidProperties[] = "invalid value for 'product_id', must be smaller than or equal to 4294967295.";
        }

        if (!is_null($this->container['product_id']) && ($this->container['product_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'product_id', must be bigger than or equal to 0.";
        }
    ...
    public function setId($id)
    {
        ...
        if (($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderItemsDTO2., must be smaller than or equal to 4294967295.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderItemsDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setIdExternal($id_external)
    {
        ...
        if ((mb_strlen($id_external) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderItemsDTO2., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($id_external) < 0)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderItemsDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setEan($ean)
    {
        ...
        if ((mb_strlen($ean) > 13)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling RestOrderItemsDTO2., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($ean) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling RestOrderItemsDTO2., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[0-9]{8,13}$/", ObjectSerializer::toString($ean)))) {
            throw new \InvalidArgumentException("invalid value for \$ean when calling RestOrderItemsDTO2., must conform to the pattern /^[0-9]{8,13}$/.");
        }
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 96)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling RestOrderItemsDTO2., must be smaller than or equal to 96.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling RestOrderItemsDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setOriginalName($original_name)
    {
        ...
        if ((mb_strlen($original_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $original_name when calling RestOrderItemsDTO2., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($original_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $original_name when calling RestOrderItemsDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setOriginalCode($original_code)
    {
        ...
        if ((mb_strlen($original_code) > 96)) {
            throw new \InvalidArgumentException('invalid length for $original_code when calling RestOrderItemsDTO2., must be smaller than or equal to 96.');
        }
        if ((mb_strlen($original_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $original_code when calling RestOrderItemsDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 65535)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling RestOrderItemsDTO2., must be smaller than or equal to 65535.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling RestOrderItemsDTO2., must be bigger than or equal to 1.');
        }
     ...
     * Sets product_id
     *
     * @param int|null $product_id Internal <a href='#tag/warehouse/paths/~1rest~1api~1warehouse~1product~1%7Bid%7D~1/get'>Product ID</a> in Apilo (according to product card)
     *
     * @return self
     */
    public function setProductId($product_id)
    {
        ...
        if (($product_id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $product_id when calling RestOrderItemsDTO2., must be smaller than or equal to 4294967295.');
        }
        if (($product_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $product_id when calling RestOrderItemsDTO2., must be bigger than or equal to 0.');
        }
     ...
     * Sets product_set
     *
     * @param int|null $product_set Product Set
     *
     * @return self
     */
