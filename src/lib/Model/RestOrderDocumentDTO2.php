...
/**
 * RestOrderDocumentDTO2 Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderDocumentDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderDocumentDTO2';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderDocumentDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setIdExternal($id_external)
    {
        ...
        if ((mb_strlen($id_external) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderDocumentDTO2., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($id_external) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderDocumentDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 64)) {
            throw new \InvalidArgumentException('invalid length for $number when calling RestOrderDocumentDTO2., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling RestOrderDocumentDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling RestOrderDocumentDTO2., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling RestOrderDocumentDTO2., must be bigger than or equal to 3.');
        }
     ...
     * Sets created_at
     *
     * @param string|null $created_at Date the document was added to Apilo
     *
     * @return self
     */
