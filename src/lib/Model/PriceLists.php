 ...
 */
class PriceLists implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceLists';
    ...
    protected static $openAPITypes = [
        'list' => '\Apilo\Model\PriceListModel[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets list
     *
     * @return \Apilo\Model\PriceListModel[]|null
     */
     ...
     * Sets list
     *
     * @param \Apilo\Model\PriceListModel[]|null $list list
     *
     * @return self
     */
