...
/**
 * RestOrderReadDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderReadDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderReadDTO';
    ...
    */
    ...
    public function setIdExternal($id_external)
    {
        ...
        if ((mb_strlen($id_external) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderReadDTO., must be smaller than or equal to 36.');
        }
    ...
    public function setOriginalCurrency($original_currency)
    {
        ...
        if ((mb_strlen($original_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $original_currency when calling RestOrderReadDTO., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($original_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $original_currency when calling RestOrderReadDTO., must be bigger than or equal to 3.');
        }
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 11)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RestOrderReadDTO., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RestOrderReadDTO., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[A-Z0-9\\.|]{10,11}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestOrderReadDTO., must conform to the pattern /^[A-Z0-9\\.|]{10,11}$/.");
        }
    ...
    public function setStatus($status)
    {
        ...
        if (($status < 1)) {
            throw new \InvalidArgumentException('invalid value for $status when calling RestOrderReadDTO., must be bigger than or equal to 1.');
        }
