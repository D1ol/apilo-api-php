...
/**
 * RestListingResponse Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestListingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestListingResponse';
    ...
    */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling RestListingResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentOffset($current_offset)
    {
        ...
        if (($current_offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_offset when calling RestListingResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setPageResultCount($page_result_count)
    {
        ...
        if (($page_result_count > 512)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling RestListingResponse., must be smaller than or equal to 512.');
        }
        if (($page_result_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling RestListingResponse., must be bigger than or equal to 0.');
        }
