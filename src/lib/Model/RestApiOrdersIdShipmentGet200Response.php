<?php
/**
 * RestApiOrdersIdShipmentGet200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestApiOrdersIdShipmentGet200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestApiOrdersIdShipmentGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_rest_api_orders__id__shipment__get_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'list' => '\Apilo\Model\RestOrderShipmentDTO[]'
    ];
    ...
    */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling RestApiOrdersIdShipmentGet200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentOffset($current_offset)
    {
        ...
        if (($current_offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_offset when calling RestApiOrdersIdShipmentGet200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setPageResultCount($page_result_count)
    {
        ...
        if (($page_result_count > 512)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling RestApiOrdersIdShipmentGet200Response., must be smaller than or equal to 512.');
        }
        if (($page_result_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling RestApiOrdersIdShipmentGet200Response., must be bigger than or equal to 0.');
        }
     ...
     * Gets list
     *
     * @return \Apilo\Model\RestOrderShipmentDTO[]|null
     */
     ...
     * Sets list
     *
     * @param \Apilo\Model\RestOrderShipmentDTO[]|null $list list
     *
     * @return self
     */
