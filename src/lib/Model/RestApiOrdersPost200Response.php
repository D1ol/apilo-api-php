...
/**
 * RestApiOrdersPost200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestApiOrdersPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_rest_api_orders__post_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['id']) > 11)) {
        ...
        if (!preg_match("/^[A-Z0-9\\.|]{10,11}$/", $this->container['id'])) {
     ...
     * Sets id
     *
     * @param string $id Internal order ID
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 11)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RestApiOrdersPost200Response., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RestApiOrdersPost200Response., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[A-Z0-9\\.|]{10,11}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestApiOrdersPost200Response., must conform to the pattern /^[A-Z0-9\\.|]{10,11}$/.");
        }
