...
/**
 * RestDocumentConfigDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestDocumentConfigDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestDocumentConfigDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Internal ID of the numbering series
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestDocumentConfigDTO., must be bigger than or equal to 0.');
        }
     ...
     * Sets type
     *
     * @param int|null $type Type of accounting document
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of Accounting document numbering series
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param int|null $status Accounting document numbering status
     *
     * @return self
     */
