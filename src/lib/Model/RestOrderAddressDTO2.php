...
/**
 * RestOrderAddressDTO2 Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderAddressDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderAddressDTO2';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderAddressDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RestOrderAddressDTO2., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RestOrderAddressDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 64)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling RestOrderAddressDTO2., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 128)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RestOrderAddressDTO2., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setStreetName($street_name)
    {
        ...
        if ((mb_strlen($street_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling RestOrderAddressDTO2., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($street_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setStreetNumber($street_number)
    {
        ...
        if ((mb_strlen($street_number) > 32)) {
            throw new \InvalidArgumentException('invalid length for $street_number when calling RestOrderAddressDTO2., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($street_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $street_number when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 128)) {
            throw new \InvalidArgumentException('invalid length for $city when calling RestOrderAddressDTO2., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setZipCode($zip_code)
    {
        ...
        if ((mb_strlen($zip_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling RestOrderAddressDTO2., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($zip_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling RestOrderAddressDTO2., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling RestOrderAddressDTO2., must be bigger than or equal to 2.');
        }
    ...
    public function setParcelIdExternal($parcel_id_external)
    {
        ...
        if ((mb_strlen($parcel_id_external) > 64)) {
            throw new \InvalidArgumentException('invalid length for $parcel_id_external when calling RestOrderAddressDTO2., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($parcel_id_external) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parcel_id_external when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setParcelName($parcel_name)
    {
        ...
        if ((mb_strlen($parcel_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $parcel_name when calling RestOrderAddressDTO2., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($parcel_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parcel_name when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setCompanyTaxNumber($company_tax_number)
    {
        ...
        if ((mb_strlen($company_tax_number) > 64)) {
            throw new \InvalidArgumentException('invalid length for $company_tax_number when calling RestOrderAddressDTO2., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($company_tax_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company_tax_number when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if ((mb_strlen($company_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling RestOrderAddressDTO2., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($company_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling RestOrderAddressDTO2., must be bigger than or equal to 0.');
        }
