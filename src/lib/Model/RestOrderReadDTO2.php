...
class RestOrderReadDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'is_encrypted' => 'bool',
        'preferences' => '\Apilo\Model\RestOrderReadDTO2Preferences',
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'order_items' => '\Apilo\Model\RestOrderItemsDTO2[]',
        'order_payments' => '\Apilo\Model\RestOrderPaymentsDTO2[]',
        'address_customer' => '\Apilo\Model\RestOrderAddressDTO2',
        'address_delivery' => '\Apilo\Model\RestOrderAddressDTO3',
        'address_invoice' => '\Apilo\Model\RestOrderAddressDTO4',
        'carrier_account' => 'int',
        'order_notes' => '\Apilo\Model\RestOrderNoteDTO3[]',
        'ordered_at' => '\DateTime',
    ...
    protected static $setters = [
        'platform_account_id' => 'setPlatformAccountId',
    ...
    protected static $getters = [
        'platform_account_id' => 'getPlatformAccountId',
    ...
    {
        $this->setIfExists('platform_account_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['platform_account_id']) && ($this->container['platform_account_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'platform_account_id', must be bigger than or equal to 1.";
        }
        ...
        if (!is_null($this->container['id']) && !preg_match("/^[A-Z0-9\\.|]{10,11}$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /^[A-Z0-9\\.|]{10,11}$/.";
        }
    ...
    /**
     * Gets platform_account_id
     *
     * @return int|null
     */
    public function getPlatformAccountId()
    {
        return $this->container['platform_account_id'];
    }

    /**
     * Sets platform_account_id
     *
     * @param int|null $platform_account_id <a href='#tag/order/paths/~1rest~1api~1orders~1platform~1map~1/get'>Sale platform account ID</a>
     *
     * @return self
     */
    public function setPlatformAccountId($platform_account_id)
    {
        if (is_null($platform_account_id)) {
            throw new \InvalidArgumentException('non-nullable platform_account_id cannot be null');
        }

        if (($platform_account_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $platform_account_id when calling RestOrderReadDTO2., must be bigger than or equal to 1.');
        }

        $this->container['platform_account_id'] = $platform_account_id;
     ...
     * Sets platform_id
     *
     * @param int $platform_id Sale platform ID
     *
     * @return self
     */
    public function setPlatformId($platform_id)
    {
        ...
        if (($platform_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $platform_id when calling RestOrderReadDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentType($payment_type)
    {
        ...
        if (($payment_type < 1)) {
            throw new \InvalidArgumentException('invalid value for $payment_type when calling RestOrderReadDTO2., must be bigger than or equal to 1.');
        }
     ...
     * Gets preferences
     *
     * @return \Apilo\Model\RestOrderReadDTO2Preferences|null
     */
     ...
     * Sets preferences
     *
     * @param \Apilo\Model\RestOrderReadDTO2Preferences|null $preferences preferences
     *
     * @return self
     */
     ...
     * Gets order_items
     *
     * @return \Apilo\Model\RestOrderItemsDTO2[]
     */
     ...
     * Sets order_items
     *
     * @param \Apilo\Model\RestOrderItemsDTO2[] $order_items Order items list
     *
     * @return self
     */
     ...
     * Gets order_payments
     *
     * @return \Apilo\Model\RestOrderPaymentsDTO2[]|null
     */
     ...
     * Sets order_payments
     *
     * @param \Apilo\Model\RestOrderPaymentsDTO2[]|null $order_payments Order payments list
     *
     * @return self
     */
     ...
     *
     * @param \Apilo\Model\RestOrderAddressDTO2 $address_customer address_customer
     *
     * @return self
     */
     ...
     *
     * @return \Apilo\Model\RestOrderAddressDTO3
     */
     ...
     *
     * @param \Apilo\Model\RestOrderAddressDTO3 $address_delivery address_delivery
     *
     * @return self
     */
     ...
     *
     * @return \Apilo\Model\RestOrderAddressDTO4|null
     */
     ...
     *
     * @param \Apilo\Model\RestOrderAddressDTO4|null $address_invoice address_invoice
     *
     * @return self
     */
    ...
    public function setCarrierAccount($carrier_account)
    {
        ...
        if (($carrier_account < 1)) {
            throw new \InvalidArgumentException('invalid value for $carrier_account when calling RestOrderReadDTO2., must be bigger than or equal to 1.');
        }
     ...
     * Gets order_notes
     *
     * @return \Apilo\Model\RestOrderNoteDTO3[]|null
     */
     ...
     * Sets order_notes
     *
     * @param \Apilo\Model\RestOrderNoteDTO3[]|null $order_notes Order notes and comments
     *
     * @return self
     */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[A-Z0-9\\.|]{10,11}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestOrderReadDTO2., must conform to the pattern /^[A-Z0-9\\.|]{10,11}$/.");
        }
