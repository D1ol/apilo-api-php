...
/**
 * RestAuthTokenPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestAuthTokenPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_rest_auth_token__post_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('developer_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets token
     *
     * @param string $token Authorization code when grant type is <code>authorization_code</code> or Refresh token when grant type is <code>refresh_token</code>
     *
     * @return self
     */
     ...
     * Sets developer_id
     *
     * @param string|null $developer_id Developer UUID (optional)
     *
     * @return self
     */
    public function setDeveloperId($developer_id)
    {
        if (is_null($developer_id)) {
            throw new \InvalidArgumentException('non-nullable developer_id cannot be null');
        }
