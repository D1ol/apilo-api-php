...
/**
 * RestOrderReadDTO2Preferences Class Doc Comment
 *
 * @category Class
 * @description Extra order fields
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestOrderReadDTO2Preferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderReadDTO2_preferences';
    ...
    {
        $this->setIfExists('id_user', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets id_user
     *
     * @param string|null $id_user id_user
     *
     * @return self
     */
    ...
    {
        if (is_null($id_user)) {
            throw new \InvalidArgumentException('non-nullable id_user cannot be null');
        }
