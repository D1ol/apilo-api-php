...
/**
 * RestOrderShipmentDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderShipmentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderShipmentDTO';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderShipmentDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setIdExternal($id_external)
    {
        ...
        if ((mb_strlen($id_external) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderShipmentDTO., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($id_external) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderShipmentDTO., must be bigger than or equal to 1.');
        }
