<?php
/**
 * DocumentDocumentCreatePreferencesDTO2
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DocumentDocumentCreatePreferencesDTO2 Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class DocumentDocumentCreatePreferencesDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentDocumentCreatePreferencesDTO2';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message Message for created document
     *
     * @return self
     */
